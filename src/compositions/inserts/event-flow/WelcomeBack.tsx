/**
 * WelcomeBack - Returning from a short break
 *
 * Complement to BreakAnnouncement. Show this when the stream resumes.
...
const TITLE = "WE ARE BACK";
const MESSAGE = "Thanks for your patience. Gameplay continues - good luck!";
